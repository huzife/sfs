...
public:
    ...
    static constexpr int file_block_count = 95977;             // 95977 blocks for file
...
private:
    ...
    std::shared_ptr<AllocMap<file_block_count>> m_file_block_map;
    std::shared_ptr<AllocMap<file_block_count>> m_inode_block_map;
